...
<body>
  ...
  <div class="reservations">
    <form class="res-form" action="../support_files/sendinfo.php" method="post">
      <input type="text" name="resName" value="" placeholder="Reservation's Name" required autocomplete="off">
      <br><input type="number" name="resSize" value="" placeholder="Size of party" required autocomplete="off">
      <br><input type="date" name="resDate" value="" required autocomplete="off">
      <br><input type="time" name="resTime" value="" required autocomplete="off">
